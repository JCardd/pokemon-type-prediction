...
os.makedirs('results/modeling/knn', exist_ok=True)
...
def preprocess_data(df):
    """
    Preprocess the data for k-NN classification
...
def evaluate_model(y_test, y_pred, le):
    ...
    with open('results/modeling/knn/classification_report.txt', 'w') as f:
    ...
    with open('results/modeling/knn/performance_metrics.txt', 'w') as f:
...
def main():
    """
    Main function to run the k-Nearest Neighbors classification model
    """
