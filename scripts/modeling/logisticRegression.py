...
os.makedirs('results/modeling/logistic_regression', exist_ok=True)
...
def evaluate_model(y_test, y_pred, le):
    ...
    with open('results/modeling/logistic_regression/classification_report.txt', 'w') as f:
    ...
    with open('results/modeling/logistic_regression/performance_metrics.txt', 'w') as f:
...
def main():
    """
    Main function to run the baseline logistic regression model
    """
    ...
    with open('results/modeling/logistic_regression/cross_validation_results.txt', 'w') as f:
