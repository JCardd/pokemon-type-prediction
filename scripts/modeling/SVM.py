...
os.makedirs('results/modeling/svm', exist_ok=True)
...
def preprocess_data(df):
    """
    Preprocess the data for SVM classification
...
def evaluate_model(y_test, y_pred, le):
    ...
    with open('results/modeling/svm/classification_report.txt', 'w') as f:
    ...
    with open('results/modeling/svm/performance_metrics.txt', 'w') as f:
...
def main():
    """
    Main function to run the SVM classification model
    """
    ...
    with open('results/modeling/svm/cross_validation_results.txt', 'w') as f:
